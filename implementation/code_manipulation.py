...
class Function:
    ...
    decorators: list[str] | None = None  # New field for decorators
    ...
    def save_to_file(self, filepath: str, append: bool = False) -> None:
        ...
        Args:
            filepath: Destination path for the generated Python code.
            append: If True, appends to the file (adding a separating newline
                when needed). Otherwise, overwrites the file.
        """
